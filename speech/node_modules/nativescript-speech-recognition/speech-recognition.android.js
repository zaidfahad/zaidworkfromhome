...
var SpeechRecognition = (function () {
    ...
    SpeechRecognition.prototype.wasPermissionGranted = function () {
        ...
        if (!hasPermission) {
            hasPermission = android.content.pm.PackageManager.PERMISSION_GRANTED ===
                ContentPackageName.ContextCompat.checkSelfPermission(utils.ad.getApplicationContext(), android.Manifest.permission.RECORD_AUDIO);
        }
    ...
    SpeechRecognition.prototype._requestPermission = function (onPermissionGranted, reject) {
        ...
        AppPackageName.ActivityCompat.requestPermissions(application.android.foregroundActivity, [android.Manifest.permission.RECORD_AUDIO], 444);
    };
