...
namespace DigisensePlatformAPIs
{
    ...
    public sealed class NpgsqlHelper
    {
        ...
        /// <returns></returns>
        public static DataTable ExecuteDataTable1(NpgsqlConnection connection, string storedProcedureName, object[] parameters)
        {
            /*--------------------------------------------------------------------------------------------
            * Function Name:	GetData
            * Description:		To get the data from the database.
            * Where Used:		
            * Returns:			Result as Datatable
            ---------------------------------------------------------------------------------------------*/
            try
            {
                //Refresh Data
                ...
                dsResult = ExecuteDataset(connection, storedProcedureName, parameters);
            ...
            {
                ex.Source += Environment.NewLine + "NpgsqlHelper.cs.ExecuteDataTable()";
                throw ex;
            }
            finally
            {
        ...
        /// <param name="parameters"></param>
        /// <returns></returns>
        public static DataTable ExecuteDataTable1(NpgsqlConnection connection, string storedProcedureName)
        {
            /*--------------------------------------------------------------------------------------------
            * Function Name:	GetData
            * Description:		To get the data from the database.
            ...
            * Returns:			Result as Datatable
            ...
            try
            {
                ...
                dsResult = ExecuteDataset(connection, CommandType.StoredProcedure, storedProcedureName);
                if (dsResult != null && dsResult.Tables.Count > 0 && dsResult.Tables[0] != null)
                {
                    dtResult = dsResult.Tables[0];
                }
        ...
        /// <param name="parameters"></param>
        /// <returns></returns>
        public static DataTable ExecuteDataTable(NpgsqlConnection connection, string storedProcedureName, object[] parameters, NpgsqlParameter[] npParameters)
        {
            /*--------------------------------------------------------------------------------------------
            * Function Name:	GetData
            * Description:		To get the data from the database.
            ...
            * Returns:			Result as Datatable
            ...
            try
            {
                ...
                NpgsqlCommand command = new NpgsqlCommand(storedProcedureName, connection);
                command.CommandType = CommandType.StoredProcedure;

                for (int iCount = 0; iCount < npParameters.Length; iCount++)
                {
                    command.Parameters.Add(npParameters[iCount]);
                    command.Parameters[iCount].Value = parameters[iCount];
                }
        ...
        /// <param name="parameters"></param>
        /// <returns></returns>
        public static DataTable ExecuteDataTable(NpgsqlConnection connection, string storedProcedureName)
        {
            /*--------------------------------------------------------------------------------------------
            * Function Name:	GetData
            * Description:		To get the data from the database.
            ...
            * Returns:			Result as Datatable
            ...
            {                
                ...
                dsResult = ExecuteDataset(transaction,CommandType.StoredProcedure, storedProcedureName);
                if (dsResult != null && dsResult.Tables.Count > 0 && dsResult.Tables[0] != null)
                {
                    dtResult = dsResult.Tables[0];
                }
    ...
    public sealed class NpgsqlHelperParameterCache
    {
        ...
        {            
            ...
            {
                //cmd.Parameters.RemoveAt(0); -- Commented To Avoid Bug " Parameter count does not match -Sri
            }
