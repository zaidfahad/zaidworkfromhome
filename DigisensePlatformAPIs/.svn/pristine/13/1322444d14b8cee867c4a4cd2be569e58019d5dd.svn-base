            ...
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    if (dtLoginInfo.Rows.Count > 0)
                    {
                        ...
                        resetPassword = DBUtilities.LoginRepository.DigiSMAResetPassword(clsresetPassword.username, clsresetPassword.phonenumber, clsresetPassword.email, RoleID, otp, newpassword, BusinessType);
