...
namespace DigisensePlatformAPIs.BLUtilities
{
    public class Vehicle_BL
    {
            ...
            try
            {
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                   ...
                   // clsVehicleSummaryResponse.vehicleLastUsed = Convert.ToDateTime(dt.Rows[i]["VehicleLastUsed"].ToString()).ToString("yyyy-MM-dd HH:mm:ss");
                    ...
                    clsVehicleSummaryResponse.runninghours = dt.Rows[i]["runninghours"].ToString() == "" ? "0" : ConvertSecondsintoHHMMSSFormat(Convert.ToDouble(dt.Rows[i]["runninghours"].ToString()));
                    clsVehicleSummaryResponse.idlehours = dt.Rows[i]["idlehours"].ToString() == "" ? "0" : ConvertSecondsintoHHMMSSFormat(Convert.ToDouble(dt.Rows[i]["idlehours"].ToString()));
                    clsVehicleSummaryResponse.TotalHours = dt.Rows[i]["TotalHours"].ToString() == "" ? "0" : ConvertSecondsintoHHMMSSFormat(Convert.ToDouble(dt.Rows[i]["TotalHours"].ToString())); 
            ...
            try
            {
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                  ...
                  //  clsMTBDVehicleSummaryResponse.TotalHours = dt.Rows[i]["TotalHours"].ToString();
                    ...
                    clsMTBDVehicleSummaryResponse.runninghours = dt.Rows[i]["runninghours"].ToString() == "" ? "0" : ConvertSecondsintoHHMMSSFormat(Convert.ToDouble(dt.Rows[i]["runninghours"]));
                    clsMTBDVehicleSummaryResponse.idlehours = dt.Rows[i]["idlehours"].ToString() == "" ? "0" : ConvertSecondsintoHHMMSSFormat(Convert.ToDouble(dt.Rows[i]["idlehours"].ToString()));
                    clsMTBDVehicleSummaryResponse.TotalHours = dt.Rows[i]["TotalHours"].ToString() == "" ? "0" : ConvertSecondsintoHHMMSSFormat(Convert.ToDouble(dt.Rows[i]["TotalHours"].ToString())); 
        ...
        public static string ConvertSecondsintoHHMMSSFormat(double secs)
        {
