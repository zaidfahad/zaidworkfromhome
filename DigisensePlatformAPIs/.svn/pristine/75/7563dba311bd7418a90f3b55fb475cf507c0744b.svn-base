...
namespace DigisensePlatformAPIs.DBUtilities
{
    public class DriverRepository
    {
        ...
        public static DataTable DriverProfileWithDriverIdUpdate(string username, DriverUpdate objDriver, int buinessId)
        {
            // Declaring Variables
            NpgsqlConnection connection = null;
            ...
            try
            {
                ...
                oNpgsqlParameter[3] = new NpgsqlParameter("email", NpgsqlDbType.Text);
                ...
                connection = DBConnection.GetConnection(Convert.ToInt16(buinessId));
                dtDriverDetails =  NpgsqlHelper.ExecuteDataTable(connection, "usp_mobileapi_update_driver_details", oParameters,oNpgsqlParameter);
            }
            catch (Exception ex)
            {
            }
