        ...
        public static List<GeofenceVehicleMappingResponse> GeofenceVehicleMappingResponse(DataTable dt)
        {
            ...
            try
            {
                ...
                for (int n = 0; n < dt.Rows.Count; n++)
                {
                    ...
                    clsGeofenceVehicleMappingResponse.vehicleRegNo = dt.Rows[n]["vehicleRegNo"].ToString();
                    clsGeofenceVehicleMappingResponse.geoFenceName = dt.Rows[n]["geofence_name"].ToString();
